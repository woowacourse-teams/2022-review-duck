...
const GITHUB_OAUTH_LOGIN_URL = `https://github.com/login/oauth/authorize?client_id=${
  import.meta.env.CLIENT_GITHUB_OAUTH_CLIENT_KEY
}`;
...
const API_URI = {
  ...
  REVIEW: {
    ...
    CREATE_FORM_BY_TEMPLATE: (templateId: numberString) => `/api/templates/${templateId}/review-forms/edited`,
