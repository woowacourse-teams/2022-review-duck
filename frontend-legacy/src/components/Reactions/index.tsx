...
function ReactionButton({ className, icon, count, onClick, children, ...rest }: ReactionBaseButtonProps) {
...
function LikeButton({ className, count, ...rest }: ReactionButtonProps) {
  return (
    <ReactionButton {...rest} className={cn(styles.likeButton, className)} icon={faHeart} count={count}>
      좋아요
    </ReactionButton>
  );
}
...
function BookmarkButton({ className, count, ...rest }: ReactionButtonProps) {
  return (
    <ReactionButton {...rest} className={cn(styles.bookmarkButton, className)} icon={faBookmark} count={count}>
      북마크
    </ReactionButton>
  );
}
