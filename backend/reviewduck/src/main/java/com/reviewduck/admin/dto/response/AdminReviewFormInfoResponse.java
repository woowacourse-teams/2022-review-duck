...
@Getter
public class AdminReviewFormInfoResponse {
    ...
    public static AdminReviewFormInfoResponse from(ReviewForm reviewForm) {
        return new AdminReviewFormInfoResponse(reviewForm.getId(), reviewForm.getMember().getId(),
